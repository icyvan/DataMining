...
* [Байесовские алгоритмы классификации](#байесовские-алгоритмы-классификации)   
   ...
   * [Постановочный алгоритм (plug-in)](#постановочный-алгоритм-(plug-in))
...
![](https://github.com/icyvan/DataMining/blob/master/images/naive1.png) 

Постановочный алгоритм (plug-in)
--------
...
--------
Если ковариационные матрицы классов одинаковые, тогда поверхность разделяющая между классами будет линейна и остается подставить общую ковариационную матрицу классов в формулу байесовского классификатора:
...
----------
Имеет кусочно-линейную функцию потерь



вывести нескольо картинов в адалайн и отобразить цветом плотности
