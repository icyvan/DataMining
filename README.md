...
--------
Если ковариационные матрицы классов одинаковые, тогда поверхность разделяющая между классами будет линейна и остается подставить эту общую ковариационную матрицу классов в формулу байесовского классификатора
