...
--------
Если предположить, что в алгоритме plug-in ковариационные матрицы классов одинаковые, тогда поверхность разделяющая между классами будет линейна и остается подставить общую ковариационную матрицу классов в формулу байесовского классификатора:
